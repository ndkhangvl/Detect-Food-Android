...
//        CompoundButton.OnCheckedChangeListener,
  ...
  protected void onCreate(final Bundle savedInstanceState) {
    ...
    toolbar.setTitle(R.string.live_detection);
    ...
    ///
    recyclerView = findViewById(R.id.recycler_realtime);
    layoutManager = new LinearLayoutManager(this);
    recyclerView.setLayoutManager(layoutManager);
    recyclerView.setHasFixedSize(true);
    database = new sqlFood(this);
    ///
  }
...
//  }
  ...
  protected void showInference(String inferenceTime) {
    ...
    System.out.println(SharedData.objects);
    List<Food> food = database.getFoodIdArray(SharedData.objects);
