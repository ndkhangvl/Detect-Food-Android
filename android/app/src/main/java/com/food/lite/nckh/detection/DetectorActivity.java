        ...
        runInBackground(
                new Runnable() {
                    ...
                    public void run() {
                        ...
                        float maxconf = 0;
                        int maxpos = -1;
                        List<Integer> realfood = new ArrayList<Integer>();
...
//                                    if (result.getConfidence() > maxconf) {
                                        maxpos = result.getDetectedClass() + 1;
                                        realfood.add(maxpos);
//                                    }
//                                }
                            }
                        }
                        List<Integer> listfood = new ArrayList<Integer>();
                        for(Integer refood : realfood) {
                            if (!listfood.contains(refood)) {
                                listfood.add(refood);
                            }
                        }
                        SharedData.objects = listfood;
